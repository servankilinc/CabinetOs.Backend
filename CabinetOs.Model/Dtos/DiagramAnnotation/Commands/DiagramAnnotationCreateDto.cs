...
{
    public class DiagramAnnotationCreateDto : IDto
    {
    ...
    public class DiagramAnnotationCreateDtoValidator : AbstractValidator<DiagramAnnotationCreateDto>
    {
        public DiagramAnnotationCreateDtoValidator()
        {
            ...
            RuleFor(v => v.CabinetId).NotNull().WithMessage("Geçersiz kabin bilgisi");
            RuleFor(v => v.CabinetId).NotEqual(Guid.Empty).WithMessage("Geçersiz kabin bilgisi");
            RuleFor(v => v.Text).NotEmpty().WithMessage("İçerik metni girilmesi gerekmekte");
            RuleFor(v => v.Shape).NotNull().WithMessage("Tip seçimi yapılmalı");
