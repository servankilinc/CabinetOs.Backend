...
namespace CabinetOs.Model.Dtos.Cabinet.Commands
{
    ...
    public class CabinetUpdateDtoValidator : AbstractValidator<CabinetUpdateDto>
    {
        public CabinetUpdateDtoValidator()
        {
            ...
            RuleFor(v => v.Name).NotNull().WithMessage("Firma bilgisi zorunlu lütfen kontrol ediniz");
            RuleFor(v => v.Name).NotEqual(Guid.Empty).WithMessage("Firma bilgisi zorunlu lütfen kontrol ediniz");
