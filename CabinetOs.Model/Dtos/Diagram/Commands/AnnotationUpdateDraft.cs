...
public class AnnotationUpdateDraft : IDto, IIdentifiableDraft
{
...
public class AnnotationUpdateDraftValidator : AbstractValidator<AnnotationUpdateDraft>
{
    public AnnotationUpdateDraftValidator()
    {
