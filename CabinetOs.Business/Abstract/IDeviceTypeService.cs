...
namespace CabinetOs.Business.Abstract
{
    public interface IDeviceTypeService
    {
        ...
        Task<Result<SelectList>> SelectListAsync(Expression<Func<DeviceType, bool>>? where = default, CancellationToken cancellationToken = default);
        Task<Result> CreateAsync(DeviceType request, CancellationToken cancellationToken = default);
