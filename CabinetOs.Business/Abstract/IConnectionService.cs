...
namespace CabinetOs.Business.Abstract
{
    public interface IConnectionService
    {
        ...
        Task<Result<SelectList>> SelectListAsync(Expression<Func<Connection, bool>>? where = default, CancellationToken cancellationToken = default);
        Task<Result> CreateAsync(ConnectionCreateDto request, CancellationToken cancellationToken = default);
