...
namespace CabinetOs.Business.Abstract
{
    public interface IDeviceStatusService
    {
        ...
        Task<Result<SelectList>> SelectListAsync(Expression<Func<DeviceStatus, bool>>? where = default, CancellationToken cancellationToken = default);
        Task<Result> CreateAsync(DeviceStatus request, CancellationToken cancellationToken = default);
