...
namespace CabinetOs.Business.Concrete
{
    public class DeviceService : IDeviceService
    {
        ...
        public async Task<Result<SelectList>> SelectListAsync(Expression<Func<Device, bool>>? where = default, CancellationToken cancellationToken = default)
        {
            var list = await _unitOfWork.Devices.GetAllAsync<object>(select: s => new { s.Id, s.Name }, where: where, cancellationToken: cancellationToken);
