...
namespace CabinetOs.Business.Concrete
{
    public class ComponentTemplatePinService : IComponentTemplatePinService
    {
        ...
        public async Task<Result<SelectList>> SelectListAsync(Expression<Func<ComponentTemplatePin, bool>>? where = default, CancellationToken cancellationToken = default)
        {
            var list = await _unitOfWork.ComponentTemplatePins.GetAllAsync<object>(select: s => new { s.Id, s.Name }, where: where, cancellationToken: cancellationToken);
