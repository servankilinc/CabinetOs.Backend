...
namespace CabinetOs.WebAPI.Controllers
{
    public class ComponentTemplateController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ComponentTemplateCreateDto request)
        {
            var result = await _componentTemplateService.CreateAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _componentTemplateService.GetUpdateModelAsync(id: id);
            return ToAction(result);
        }
        ...
        {
            var result = await _componentTemplateService.PaginationAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _componentTemplateService.DatatableClientSideAsync(request);
            return ToAction(result);
        }
        ...
        {
            var result = await _componentTemplateService.DatatableServerSideAsync(request);
            return ToAction(result);
        }
    }
}
